...
def find_optimized_paths(flights, start_city, end_city, t1, t2):
    ...
    def dfs(current_city, current_path, total_time, total_fare, flights_taken, prev_flight):
        ...
        for flight in flights:
            ...
            dfs(flight.end_city, current_path, new_time, new_fare, new_flights_taken, flight)
...
def main():
    ...
    for i in range(len(expected_route2)):
        print(expected_route2[i].flight_no)

    for i in range(len(route2)):
        print(route2[i].flight_no)
    ...
    # for flights in expected_route3:
    #     print(flights.flight_no, end = "  ")
    # print()
