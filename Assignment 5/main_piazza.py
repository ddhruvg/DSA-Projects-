...
# #         u,v,cost,t1,t2=file.readline().split(" ")
# #         flights.append(Flight(i,int(u),int(t1),int(v),int(t2),int(cost)))

# # planner=Planner(flights)
# # # planner.print_flight_adj_list()
# # route1 = planner.least_flights_earliest_route(0,101,0,1100)
# # for flights in route1:
# #     print(flights.flight_no, end = " ")
# # print()
# # route2 = planner.cheapest_route(0,101,0,1100)
# # for flights in route2:
# #     print(flights.flight_no, end =  " ")
# # print()
# # route3 = planner.least_flights_cheapest_route(0,101,0,1100)
# # for flights in route3:
# #     print(flights.flight_no, end = " ")
# # print()
# # import time 
# # from flight import Flight
...
# #     for i in range(int(m)):
# #         u,v,cost,t1,t2=file.readline().split(" ")
# #         flights.append(Flight(i,int(u),int(v),int(t1),int(t2),int(cost)))

# # planner=Planner(flights)
# # start = time.time()
# # print(planner.least_flights_earliest_route(0,100,0,1100))

# # print(planner.cheapest_route(0,100,0,1100))
# # print(planner.least_flights_cheapest_route(0,100,0,1100))
