...
def test_complex_network_cheapest_route():
    ...
    flights = [
        ...
        Flight(1 - 1, 0, 0, 1, 120, 300),      # NY -> Chicago: expensive direct
        Flight(2 - 1, 0, 60, 1, 180, 250),     # NY -> Chicago: cheaper direct
        Flight(3 - 1, 0, 0, 3, 360, 800),      # NY -> LA: expensive direct
        Flight(4 - 1, 0, 0, 2, 180, 150),      # NY -> Denver: cheap flight
        Flight(12 - 1, 0, 30, 2, 210, 200),    # NY -> Denver: alternative route
        Flight(13 - 1, 0, 0, 4, 180, 400),     # NY -> Seattle: direct option
        Flight(19 - 1, 0, 80, 1, 190, 250),    # NY -> Chicago: medium cost
        
        # Connections through Chicago (1)
        Flight(5 - 1, 1, 140, 3, 300, 200),    # Chicago -> LA: medium cost
        Flight(6 - 1, 1, 200, 3, 360, 180),    # Chicago -> LA: cheaper option
        Flight(14 - 1, 1, 200, 4, 350, 250),   # Chicago -> Seattle: medium route
        Flight(15 - 1, 1, 210, 4, 360, 200),   # Chicago -> Seattle: cheaper route
        
        # Connections through Denver (2)
        Flight(7 - 1, 2, 200, 3, 380, 200),    # Denver -> LA: medium cost
        Flight(11 - 1, 2, 200, 3, 290, 100),   # Denver -> LA: cheapest option
        Flight(16 - 1, 2, 220, 4, 380, 150),   # Denver -> Seattle: good route
        
        # Seattle connections (4)
        Flight(17 - 1, 4, 200, 3, 360, 180),   # Seattle -> LA: medium route
        Flight(18 - 1, 4, 380, 3, 480, 300),   # Seattle -> LA: expensive route
        Flight(20 - 1, 4, 370, 2, 380, 200),   # Seattle -> Denver: medium route
        # Return flights
        Flight(8 - 1, 1, 400, 0, 520, 300),    # Chicago -> NY
        Flight(9 - 1, 3, 400, 0, 760, 800),    # LA -> NY
        
        # Late flights
        Flight(10 - 1, 0, 500, 3, 860, 700),   # NY -> LA: expensive late direct
    ]
    ...
    test_scenarios = [
        # Original test cases...
        {
            ...
            "expected_flight_numbers": [2 - 1],  # Should take cheaper direct flight
        ...
        },
        {
            ...
            "expected_flight_numbers": [4 - 1, 11 - 1],  
        ...
        # New complex test cases with multiple valid paths but one optimal solution
        {
            ...
            "expected_flight_numbers": [4 - 1, 16 - 1],
        ...
        },
        {
            ...
            "expected_flight_numbers": [2 - 1, 6 - 1],
        ...
        },
        {
            ...
            "expected_flight_numbers": [2 - 1,14 - 1],  
        ...
        },
        {
            ...
            "expected_flight_numbers": [17 - 1, 9 - 1],
        ...
        },
        {
            ...
            "expected_flight_numbers": [19 - 1, 15 - 1, 18 - 1],
        ...
        },
        {
            ...
            "expected_flight_numbers": [14 - 1,20 - 1],
